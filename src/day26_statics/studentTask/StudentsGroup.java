...
public class StudentsGroup { // StudentsGroup HAS A Student
    ...
    public void addStudent(Student student){     // *****First way to add Student ********
        students.add(student);
    }// Takes one student object, and adds it to the arraylist of students

    public void addStudent(Student[] students){              // *****Second way to add Student ********
        this.students.addAll(Arrays.asList(students));
    } // Takes one array of students, and adds the array of students to the arraylist of students

    public void addStudent(String name, int age, char gender, String id){           // *****Third way to add Student ********

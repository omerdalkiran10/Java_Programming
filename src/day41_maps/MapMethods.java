...
public class MapMethods {
    ...
    public static void main(String[] args) {
        ...
        map.put("A04", "Lucy");     // If you want to change the value of key, you should write first key then the new value.
        map.put("A06", "Madiyar");
        ...
        map.replace("C02", "Aseel");    // replace(key, newValue): replaces the value of the specified key with the new value- ( you can also replace with                                      put method, but replace method is faster as performance)
